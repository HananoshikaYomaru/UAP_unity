...
public class UAP_AccessibilityManager : MonoBehaviour
{
    ...
    private void LoadLocalization()
    {
        ...
        Debug.LogWarning($"{localizationLines[0]}");
        Debug.LogWarning($"{supportedLanguages[1]}");
        Debug.LogWarning($"{supportedLanguages[2]}");
        Debug.LogWarning($"{supportedLanguages[3]}");

        Debug.LogWarning($"{supportedLanguages[4]}");
        Debug.LogWarning($"{supportedLanguages[5]}");
