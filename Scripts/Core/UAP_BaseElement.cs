...
public abstract class UAP_BaseElement : MonoBehaviour
{
    ...
    /// </summary>
    [Tooltip("This variable contains the text that will be read aloud if this UI element receives focus. This variable will only be used if the plugin is not reading text directly from a text label.")]
